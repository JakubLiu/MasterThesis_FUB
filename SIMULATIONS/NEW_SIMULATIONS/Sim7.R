#Quadratic (concave) alternative pattern, constant sample size, variable dimensionality.
...
write.csv(sim_tab, '/media/DANE/home/jliu/MASTER_THESIS_BER/SIMULATIONS/NEW_SIMULATIONS/Sim7.results.csv')
