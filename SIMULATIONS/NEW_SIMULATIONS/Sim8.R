#Quadratic (convex) alternative pattern, variable effect size
...
write.csv(sim_tab, '/media/DANE/home/jliu/MASTER_THESIS_BER/SIMULATIONS/NEW_SIMULATIONS/Sim8.results.csv')
