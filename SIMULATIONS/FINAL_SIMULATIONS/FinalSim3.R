...
for(i in 1:nrow(variable_grid)){
  ...
  means_convex <- f_quadratic(means_linear, 'concave')
...
write.csv(results, '/media/DANE/home/jliu/MASTER_THESIS_BER/SIMULATIONS/FINAL_SIMULATIONS/FinalSim3.results.csv')