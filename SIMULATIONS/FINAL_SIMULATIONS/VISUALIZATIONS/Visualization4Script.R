...
Toeplitz_dim10_eff05050 <- Toeplitz_dim10[Toeplitz_dim10$var_effectsizes == 0.5050, ]
Toeplitz_dim10_eff07525 <- Toeplitz_dim10[Toeplitz_dim10$var_effectsizes == 0.7525, ]
Toeplitz_dim10_eff1 <- Toeplitz_dim10[Toeplitz_dim10$var_effectsizes == 1.0000, ]
...
Toeplitz_dim20_eff05050 <- Toeplitz_dim20[Toeplitz_dim20$var_effectsizes == 0.5050, ]
Toeplitz_dim20_eff07525 <- Toeplitz_dim20[Toeplitz_dim20$var_effectsizes == 0.7525, ]
Toeplitz_dim20_eff1 <- Toeplitz_dim20[Toeplitz_dim20$var_effectsizes == 1.0000, ]
...
Toeplitz_dim30_eff05050 <- Toeplitz_dim30[Toeplitz_dim30$var_effectsizes == 0.5050, ]
Toeplitz_dim30_eff07525 <- Toeplitz_dim30[Toeplitz_dim30$var_effectsizes == 0.7525, ]
Toeplitz_dim30_eff1 <- Toeplitz_dim30[Toeplitz_dim30$var_effectsizes == 1.0000, ]
...
Toeplitz_dim50_eff05050 <- Toeplitz_dim50[Toeplitz_dim50$var_effectsizes == 0.5050, ]
Toeplitz_dim50_eff07525 <- Toeplitz_dim50[Toeplitz_dim50$var_effectsizes == 0.7525, ]
Toeplitz_dim50_eff1 <- Toeplitz_dim50[Toeplitz_dim50$var_effectsizes == 1.0000, ]
...
lines(AR1_dim10_eff05050$var_samplesizes, AR1_dim10_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR1_dim10_eff05050$var_samplesizes, AR1_dim10_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
lines(AR1_dim10_eff02575$var_samplesizes, AR1_dim10_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR1_dim10_eff05050$var_samplesizes, AR1_dim10_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR1_dim10_eff07525$var_samplesizes, AR1_dim10_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR1_dim10_eff1$var_samplesizes, AR1_dim10_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR1_dim20_eff05050$var_samplesizes, AR1_dim20_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR1_dim20_eff05050$var_samplesizes, AR1_dim20_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR1_dim20_eff001$var_samplesizes, AR1_dim20_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR1_dim20_eff02575$var_samplesizes, AR1_dim20_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR1_dim20_eff05050$var_samplesizes, AR1_dim20_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR1_dim20_eff07525$var_samplesizes, AR1_dim20_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR1_dim20_eff1$var_samplesizes, AR1_dim20_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR1_dim30_eff05050$var_samplesizes, AR1_dim30_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR1_dim30_eff05050$var_samplesizes, AR1_dim30_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR1_dim30_eff001$var_samplesizes, AR1_dim30_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR1_dim30_eff02575$var_samplesizes, AR1_dim30_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR1_dim30_eff05050$var_samplesizes, AR1_dim30_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR1_dim30_eff07525$var_samplesizes, AR1_dim30_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR1_dim30_eff1$var_samplesizes, AR1_dim30_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR1_dim50_eff05050$var_samplesizes, AR1_dim50_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR1_dim50_eff05050$var_samplesizes, AR1_dim50_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR1_dim50_eff001$var_samplesizes, AR1_dim50_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR1_dim50_eff02575$var_samplesizes, AR1_dim50_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR1_dim50_eff05050$var_samplesizes, AR1_dim50_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR1_dim50_eff07525$var_samplesizes, AR1_dim50_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR1_dim50_eff1$var_samplesizes, AR1_dim50_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR2_dim10_eff05050$var_samplesizes, AR2_dim10_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR2_dim10_eff05050$var_samplesizes, AR2_dim10_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR2_dim10_eff001$var_samplesizes, AR2_dim10_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR2_dim10_eff02575$var_samplesizes, AR2_dim10_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR2_dim10_eff05050$var_samplesizes, AR2_dim10_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR2_dim10_eff07525$var_samplesizes, AR2_dim10_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR2_dim10_eff1$var_samplesizes, AR2_dim10_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR2_dim20_eff05050$var_samplesizes, AR2_dim20_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR2_dim20_eff05050$var_samplesizes, AR2_dim20_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR2_dim20_eff001$var_samplesizes, AR2_dim20_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR2_dim20_eff02575$var_samplesizes, AR2_dim20_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR2_dim20_eff05050$var_samplesizes, AR2_dim20_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR2_dim20_eff07525$var_samplesizes, AR2_dim20_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR2_dim20_eff1$var_samplesizes, AR2_dim20_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR2_dim30_eff05050$var_samplesizes, AR2_dim30_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR2_dim30_eff05050$var_samplesizes, AR2_dim30_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR2_dim30_eff001$var_samplesizes, AR2_dim30_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR2_dim30_eff02575$var_samplesizes, AR2_dim30_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR2_dim30_eff05050$var_samplesizes, AR2_dim30_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR2_dim30_eff07525$var_samplesizes, AR2_dim30_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR2_dim30_eff1$var_samplesizes, AR2_dim30_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(AR2_dim50_eff05050$var_samplesizes, AR2_dim50_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(AR2_dim50_eff05050$var_samplesizes, AR2_dim50_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(AR2_dim50_eff001$var_samplesizes, AR2_dim50_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(AR2_dim50_eff02575$var_samplesizes, AR2_dim50_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(AR2_dim50_eff05050$var_samplesizes, AR2_dim50_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(AR2_dim50_eff07525$var_samplesizes, AR2_dim50_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(AR2_dim50_eff1$var_samplesizes, AR2_dim50_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(Toeplitz_dim10_eff05050$var_samplesizes, Toeplitz_dim10_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(Toeplitz_dim10_eff05050$var_samplesizes, Toeplitz_dim10_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(Toeplitz_dim10_eff001$var_samplesizes, Toeplitz_dim10_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(Toeplitz_dim10_eff02575$var_samplesizes, Toeplitz_dim10_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(Toeplitz_dim10_eff05050$var_samplesizes, Toeplitz_dim10_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(Toeplitz_dim10_eff07525$var_samplesizes, Toeplitz_dim10_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(Toeplitz_dim10_eff1$var_samplesizes, Toeplitz_dim10_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(Toeplitz_dim20_eff05050$var_samplesizes, Toeplitz_dim20_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(Toeplitz_dim20_eff05050$var_samplesizes, Toeplitz_dim20_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(Toeplitz_dim20_eff001$var_samplesizes, Toeplitz_dim20_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(Toeplitz_dim20_eff02575$var_samplesizes, Toeplitz_dim20_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(Toeplitz_dim20_eff05050$var_samplesizes, Toeplitz_dim20_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(Toeplitz_dim20_eff07525$var_samplesizes, Toeplitz_dim20_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(Toeplitz_dim20_eff1$var_samplesizes, Toeplitz_dim20_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(Toeplitz_dim30_eff05050$var_samplesizes, Toeplitz_dim30_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(Toeplitz_dim30_eff05050$var_samplesizes, Toeplitz_dim30_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(Toeplitz_dim30_eff001$var_samplesizes, Toeplitz_dim30_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(Toeplitz_dim30_eff02575$var_samplesizes, Toeplitz_dim30_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(Toeplitz_dim30_eff05050$var_samplesizes, Toeplitz_dim30_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(Toeplitz_dim30_eff07525$var_samplesizes, Toeplitz_dim30_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(Toeplitz_dim30_eff1$var_samplesizes, Toeplitz_dim30_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
...
lines(Toeplitz_dim50_eff05050$var_samplesizes, Toeplitz_dim50_eff05050$powers_glob, lwd = 4, col = 'cyan2')
...
lines(Toeplitz_dim50_eff05050$var_samplesizes, Toeplitz_dim50_eff05050$powers_mctp, lwd = 4, col = 'darkorange2')
...
plot(Toeplitz_dim50_eff001$var_samplesizes, Toeplitz_dim50_eff001$powers_mctp_modified,
     ...
     ylim = c(0, 1), xlab = "Sample Size", ylab = "Power",
     main = "MCTP + WB Modified")
lines(Toeplitz_dim50_eff02575$var_samplesizes, Toeplitz_dim50_eff02575$powers_mctp_modified, lwd = 4, col = 'darkolivegreen2')
lines(Toeplitz_dim50_eff05050$var_samplesizes, Toeplitz_dim50_eff05050$powers_mctp_modified, lwd = 4, col = 'darkolivegreen3')
lines(Toeplitz_dim50_eff07525$var_samplesizes, Toeplitz_dim50_eff07525$powers_mctp_modified, lwd = 4, col = 'darkolivegreen4')
lines(Toeplitz_dim50_eff1$var_samplesizes, Toeplitz_dim50_eff1$powers_mctp_modified, lwd = 4, col = 'darkolivegreen')
grid()
