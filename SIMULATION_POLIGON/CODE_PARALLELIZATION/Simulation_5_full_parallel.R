...
# Define paths to output and log files
output_file_path <- ""
log_file_path <- "Sim5_full_parallel.log"
...
sample_sizes <- c(step5_10, step_11_100) # level 2
...
dimensions <- c(dim_step1, dim_step2)  # level 3

variance <- seq(from = 0, to = 10, by = 1)  # level 4

correlation_abs <- seq(from = 0, to = 1, by = 0.1)  # level 5  (I don't look at the sign of the correlation)
...
n_rep <- 2 # number of times the data is simulated under the given conditions  !!!!!!!!!!!!!!!!
