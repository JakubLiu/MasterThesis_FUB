...
```{r}
plot1 <- ggplot(Unst[Unst$n_iters_maxtest == min_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the number of sample sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(Unst[Unst$n_iters_maxtest == max_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
...
```{r}
plot1 <- ggplot(AR1[AR1$n_iters_maxtest == min_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the sample sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(AR1[AR1$n_iters_maxtest == max_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
...
```{r}
plot1 <- ggplot(AR2[AR2$n_iters_maxtest == min_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the sample sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(AR2[AR2$n_iters_maxtest == max_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
  ggtitle("Power of the maximum test across the sample sizes for an iteration number of 20000") +
  theme(plot.title = element_text(size = 7))
...
```{r}
plot1 <- ggplot(Toe[Toe$n_iters_maxtest == min_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the sample sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(Toe[Toe$n_iters_maxtest == max_iter,], aes(x = sample_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
  ggtitle("Power of the maximum test across the sample sizes for an iteration number of 20000") +
  theme(plot.title = element_text(size = 7))
...
## Unstructured covariance matrix
```{r}
plot1 <- ggplot(Unst[Unst$n_iters_maxtest == min_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(Unst[Unst$n_iters_maxtest == max_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
...
## AR(1) covariance matrix
```{r}
plot1 <- ggplot(AR1[AR1$n_iters_maxtest == min_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(AR1[AR1$n_iters_maxtest == max_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 20000") +
  theme(plot.title = element_text(size = 7))
...
## AR(2) covariance matrix
```{r}
plot1 <- ggplot(AR2[AR2$n_iters_maxtest == min_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(AR2[AR2$n_iters_maxtest == max_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 20000") +
  theme(plot.title = element_text(size = 7))
...
## Toeplitz covariance matrix
```{r}
plot1 <- ggplot(Toe[Toe$n_iters_maxtest == min_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "blue") + 
  geom_line(color = "blue", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 1000") +
  theme(plot.title = element_text(size = 7))

plot2 <- ggplot(Toe[Toe$n_iters_maxtest == max_iter,], aes(x = effect_sizes, y = power_max)) +
  geom_point(color = "red") + 
  geom_line(color = "red", linetype = "dashed") +
  ggtitle("Power of the maximum test across the effect sizes for an iteration number of 20000") +
  theme(plot.title = element_text(size = 7))
